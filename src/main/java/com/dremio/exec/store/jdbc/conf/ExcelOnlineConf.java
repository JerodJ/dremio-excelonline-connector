...
@SourceType(value = "ExcelOnlineARP", label = "ExcelOnline",uiConfig = "excelonline-layout.json")
public class ExcelOnlineConf extends AbstractArpConf<ExcelOnlineConf> {
  private static final String ARP_FILENAME = "arp/implementation/excelonline-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.excelonline.ExcelOnlineDriver";
